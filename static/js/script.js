document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchDigitosResults() {
        ...
        const tableBody = document.getElementById('DuplaSenaResults').getElementsByTagName('tbody')[0];
    ...
    function renderResults(results) {
        ...
        if (!resultsInfoDiv) {
            ...
            const tableContainer = document.getElementById('DuplaSenaResults').parentNode;
            tableContainer.insertBefore(infoDiv, document.getElementById('DuplaSenaResults'));
        } else {
