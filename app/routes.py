...
def get_resultados():
    cache_key = 'duplasena:resultados'
    ...
    try:
        logger.info(f"Buscando dados na API: {API_BASE_URL}/duplasena")
        response = requests.get(f"{API_BASE_URL}/duplasena")
